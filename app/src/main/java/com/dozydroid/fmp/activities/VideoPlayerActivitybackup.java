...
public class VideoPlayerActivitybackup extends AppCompatActivity {
...
//    private int brightness;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videosDBHandler = new VideosDBHandler(VideoPlayerActivitybackup.this, null, null, 0);
        ...
        imgBtnFavorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(isAlreadyFavorite){
                    ...
                    Toast.makeText(VideoPlayerActivitybackup.this, "Removed from favorites", Toast.LENGTH_SHORT).show();
                }else{
                    isAlreadyFavorite = true;
                    imgBtnFavorite.setImageResource(R.drawable.ic_favorite_red);
                    videosDBHandler.addVideo(thisVideo, VideosDBHandler.KEY_FAVORITE);
                    Toast.makeText(VideoPlayerActivitybackup.this, "Added to favorites", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//        touchListener = new OnSwipeTouchListener(VideoPlayerActivity.this){
//            public void onSwipeTop() {
//                Toast.makeText(VideoPlayerActivity.this, "top", Toast.LENGTH_SHORT).show();
//            }
//
//            @Override
//            public void onSwipeLeft(int difference) {
//                super.onSwipeLeft(difference);
//                Toast.makeText(VideoPlayerActivity.this, "Left: "+difference, Toast.LENGTH_SHORT).show();
//            }
//
//            @Override
//            public void onSwipeRight(int difference) {
//                super.onSwipeRight(difference);
//                Toast.makeText(VideoPlayerActivity.this, "Right: "+difference, Toast.LENGTH_SHORT).show();
//            }
//
